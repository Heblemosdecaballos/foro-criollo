...
export default async function UsuarioPage({ params }: UsuarioPageProps) {
  ...
  if (!canView) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#F5E9DA] via-white to-[#EBDDCB] dark:from-[#4B2E2E] dark:via-[#3A2323] dark:to-[#2D1B1B] flex items-center justify-center">
