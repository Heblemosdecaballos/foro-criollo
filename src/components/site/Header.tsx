...
/** Menú principal (en el orden de la segunda captura) */
const NAV = [
...
export default async function Header() {
  ...
  return (
    // Fondo BEIGE como en la segunda imagen, con borde abajo.
    <header className="sticky top-0 z-50 w-full border-b bg-site-beige/95 backdrop-blur supports-[backdrop-filter]:bg-site-beige/80">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
        ...
        {/* Acciones (tal como en la segunda imagen: NO mostramos 'Crear Foro' aquí) */}
        <div className="hidden md:flex items-center gap-2">
          {user ? (
            <Link
              href="/perfil"
              className="rounded-full border px-4 py-2 bg-white/70 hover:bg-white"
            >
              Mi cuenta
            </Link>
          ) : (
            <>
              ...
              <Link
                href="/registro"
                className="rounded-full bg-green-700 px-4 py-2 text-white shadow-sm hover:shadow"
              >
                Registrarse
              </Link>
            </>
            ...
            <div className="flex flex-col">
              ...
              {user ? (
                ...
                <>
                  ...
                  <Link
                    href="/registro"
                    className="rounded px-3 py-2 hover:bg-gray-50 text-green-700"
                  >
                    Registrarse
                  </Link>
                </>
